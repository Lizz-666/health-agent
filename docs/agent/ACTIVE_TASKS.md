...
| Phase 8 Task 2 | Codex sole real-HTTP runner, evaluation, CI, cold reviewer, and Gate 2 acceptor | `codex/phase8-implementation` / `health-worktrees/phase8-implementation` | `3de6d3f1b47b6403e321710b4216eeb81636aa6a` | `in_progress` | 允许 `scripts/phase8.py`、`backend/tests/test_phase8_{http_journey,evaluations}.py`、两个 `backend/tests/data/phase8_*_cases.v1.json`、`scripts/verify.py`、`backend/tests/test_verify_runner.py`、`.github/workflows/ci.yml` 和 focused run 文档；目标是真实 localhost/JWT journey、版本化安全/Agent eval、fail-fast CLI 与非 live CI job。Task 3/OpenCode 在 Gate 2 exact-SHA 接受前禁止启动。 |
